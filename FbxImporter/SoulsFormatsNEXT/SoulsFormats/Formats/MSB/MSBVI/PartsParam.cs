...
namespace SoulsFormats
{
    public partial class MSBVI
    {
        ...
        public class PartsParam : Param<Part>, IMsbParam<IMsbPart>
        {
            ...
            internal override Part ReadEntry(BinaryReaderEx br, long offsetLength)
            {
                ...
                switch (type)
                {
                    ...
                    case PartType.Asset:
                        return Assets.EchoAdd(new Part.Asset(br, CurrentVersion));
        ...
        public abstract class Part : Entry, IMsbPart
        {
            ...
            internal virtual void GetNames(MSBVI msb, Entries entries)
            {
                ModelName = MSB.FindName(entries.Models, ModelIndex);
            }

            internal virtual void GetIndices(MSBVI msb, Entries entries)
            {
            ...
            public abstract class EnemyBase : Part
            {
                ...
                internal override void GetNames(MSBVI msb, Entries entries)
                {
                ...
                internal override void GetIndices(MSBVI msb, Entries entries)
                {
